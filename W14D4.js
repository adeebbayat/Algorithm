...
class SinglyLinkedList {
    ...
    prepend(newVal, targetVal) {
        ...
        if (this.head === null) {
            console.log("hello from edge case empty");
            this.head = newNode
            return newNode;
        }
        //   Edge Case only 1 item inside
        if (this.head === targetVal) {
            console.log("hello from edge case 1");
            this.head.next = this.head;
            this.head.data = newNode;
            return newNode;
        }

        let runner = this.head;
        while (runner.data != targetVal && runner) {

            if (runner.next === targetVal) {
