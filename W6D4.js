...
console.log(isRotation(strA1,strB1)+ " should be " + expected1)
console.log(isRotation(strA2,strB2)+ " should be " + expected2)
console.log(isRotation(strA3,strB3)+ " should be " + expected3)
